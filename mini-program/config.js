...
module.exports = {
  ...
  // ========== 缓存策略配置 (单位: 分钟) ==========
  // 注意：云函数端有独立的内存缓存(TTL)和定时刷新机制
  // 此处为小程序端本地缓存，建议设短以获取最新数据
  cache: {
    hotTopics: 2,
    schedule: 1,       // 赛程 1分钟（云函数端60s自动回源）
    liveScore: 0.5,    // 实时比分 30秒（高频刷新）
    standings: 2,      // 积分榜 2分钟（云函数端120s）
    news: 15,
    teams: 1440        // 球队信息变化慢，可长缓存
  },
